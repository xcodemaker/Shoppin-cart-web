...
<header class="cd-auto-hide-header">
    ...
    <nav class="cd-primary-nav">
        ...
        <ul id="cd-navigation " class="card">
                   ...
                   <!--  <li><a href="login.php" ><i class="fa fa-user" aria-hidden="true"></i><?php echo "Hi,".$_SESSION["name"];?></a></li> -->
...
<div class="banner-top">
    <div class="container">
        <h3 >Details</h3>
        <h4><a href="index.php">Home</a><label>/</label>Details</h4>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <p class="lead"></p>
                <div class="list-group" id="details_category">
            ...
            <div class="col-md-9">
                ...
                <div class="thumbnail" id="details">
    ...
    <div class="row" style="margin-top:40px;">
        ...
        <div class="well well-sm">
            ...
            <div class="row" id="post-review-box" style="display:none;">
                <div class="col-md-12">
                    <form accept-charset="UTF-8" action="" method="post" id="idForm">
...
$.ajax({
            ...
            url : "actiondetails.php",
            method :"POST",
            data : {commentinput:1,comments:comment,p_id:pro_id},
