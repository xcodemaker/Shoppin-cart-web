	...
	<div class="container">
		...
		<div class="regisFrm">
			<form action="#" method="post">
				<input type="email" name="email" value="<?php echo $email; ?>" placeholder="EMAIL" required="" readonly>
				<div class="send-button">
					<input type="submit" id='continueforgotpass' name="forgotSubmit" value="CONTINUE">
				</div>
			</form>
		</div>
	</div>
